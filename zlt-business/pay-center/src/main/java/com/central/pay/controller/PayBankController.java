...
public class PayBankController {
    ...
    public PageResult list(@RequestParam Map<String, Object> params) {
        return payBankService.findList(params);
    }
    ...
    public Result findUserById(@PathVariable Long id) {
        PayBank model = payBankService.getById(id);
    ...
    @PostMapping
    public Result save(@RequestBody PayBank payBank) {
        payBankService.saveOrUpdate(payBank);
